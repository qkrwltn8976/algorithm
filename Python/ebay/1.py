...
li = list(product(*schedule))
for item in li:
    print(item)
#print(len(li))테스트 재설정
20214Q_SoftwareEngineer_코딩테스트_A for 박지수
Python3 레퍼런스
컴파일 옵션
1
2
...
테스트 1
입력값 〉
[["MO 12:00 WE 14:30", "MO 12:00", "MO 15:00", "MO 18:00"], ["TU 09:00", "TU 10:00", "TU 15:00", "TU 18:00"], ["WE 09:00", "WE 12:00", "WE 15:00", "WE 18:00"], ["TH 09:30", "TH 11:30", "TH 15:00", "TH 18:00"], ["FR 15:00", "FR 15:00", "FR 15:00", "FR 15:00"]]
기댓값 〉
896
실행 결과 〉
실행한 결괏값 1024이(가) 기댓값 896와(과) 다릅니다.
테스트 결과 (~˘▾˘)~
1개 중 0개 성공
